            ...
            <div class="col-md-9 col-footer">
                <div class="row">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="row">
                            <span class="text-right"><i class="fas fa-map-marker"></i> Ciudad de México | Tlaxcala, México</span>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 text-center mt-4">
                        <span class="mt-3">&copy; hxa.dev, Todos los derechos reservados</span>
                    </div>
                </div>
            </div>
