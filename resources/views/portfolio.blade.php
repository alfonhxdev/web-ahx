<section id="portfolio" class="portfolio">
    <div class="container">
        <h1 data-aos="zoom-in-up"> <i class="fas fa-tasks"></i> Portafolio</h1>
        <p data-aos="zoom-in" data-aos-duration="1000">Revisa los últimos proyectos que he desarrollado.</p>
